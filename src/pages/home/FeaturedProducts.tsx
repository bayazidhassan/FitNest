  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-0">
      <div className="flex flex-col md:flex-row justify-between items-center gap-2 mb-6">
        ...
        <Link
          to="/products"
          className="bg-[#F97316] font-semibold text-white py-2 px-4 rounded-lg border border-gray-300 shadow hover:bg-[#ea5f0d]"
        >
          Explore More
        </Link>
      </div>
        ...
        {products?.map((product: TProduct) => (
          ...
          >
            ...
            <Link
              ...
              className="mt-auto mb-4 bg-[#0D9488] font-semibold text-white py-2 px-4 rounded-lg border border-gray-300 shadow hover:bg-[#0a766f]"
            >
              View Details
            </Link>
          </div>
