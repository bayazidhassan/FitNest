...
const Register = () => {
  ...
  return (
    <div className="min-h-[88vh] flex items-center justify-center p-4 md:p-0">
      <div className="bg-white border border-gray-400 shadow-lg rounded-lg p-8 w-full max-w-4xl">
        ...
        <form onSubmit={handleRegister} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="col-span-2">
            <button
              type="submit"
              disabled={isLoading}
              className="cursor-pointer w-full border border-gray-300 shadow bg-[#0D9488] text-white py-3 rounded-lg hover:bg-[#0a766f] transition disabled:cursor-not-allowed disabled:opacity-50"
            >
