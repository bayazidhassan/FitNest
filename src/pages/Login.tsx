...
const Login = () => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 md:px-0">
      <div className="bg-white border border-gray-400 shadow-lg rounded-lg p-6 w-full max-w-sm">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            disabled={isLoading}
            type="submit"
            className="cursor-pointer w-full border border-gray-300 shadow bg-[#0D9488] text-white py-2 rounded-lg hover:bg-[#0a766f] transition disabled:cursor-not-allowed disabled:opacity-50"
          >
