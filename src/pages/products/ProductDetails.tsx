...
const ProductDetails = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-3">
      ...
      <div className="rounded-xl border border-gray-400 bg-gray-50 shadow-md p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Images */}
          <div>
            <div className="aspect-square max-w-sm md:max-w-md mx-auto shadow rounded-lg overflow-hidden bg-white border border-gray-400">
              <img
                src={mainImage!}
                alt={product.name}
