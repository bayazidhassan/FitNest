const AboutUs = () => {
  return (
    <div className="my-6 max-w-7xl mx-auto px-4 space-y-16">
      {/* Company Overview */}
      <section className="text-center">
        ...
        <div className="mt-6 grid sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
          <div className="border bg-white p-6 rounded-lg shadow hover:shadow-xl transition-shadow duration-300">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8">
          {/* Member 1 */}
          <div className="border bg-white p-6 rounded-lg shadow text-center hover:shadow-xl transition-shadow duration-300">
            <img
            ...
            <p className="text-justify md:text-center text-gray-600 mt-2">
              Passionate about fitness and innovation, Alex leads the company with a vision for
              global well-being.
            </p>
          </div>
          ...
          <div className="border bg-white p-6 rounded-lg shadow text-center hover:shadow-xl transition-shadow duration-300">
            <img
              ...
              className="w-32 h-32 rounded-full mx-auto object-cover mb-4"
            />
            <h3 className="text-xl font-semibold text-gray-800">Sofia Martinez</h3>
            <p className="text-[#0D9488] font-medium">Product Manager</p>
            <p className="text-justify md:text-center text-gray-600 mt-2">
              Sofia ensures every FitNest product meets our high standards of performance and
              quality.
            </p>
          </div>
          ...
          <div className="border bg-white p-6 rounded-lg shadow text-center hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-justify md:text-center text-gray-600 mt-2">
              Dedicated to helping customers, Daniel ensures smooth communication and excellent
              service.
            </p>
          </div>
        </div>
      ...
      {/* Testimonials */}
      <section>
        <h2 className="text-2xl md:text-3xl font-bold text-[#0D9488] text-center mb-6">
      ...
      <section className="bg-[#0D9488] text-white p-10 rounded-lg">
        ...
        <div className="space-y-2">
          ...
          <p>
            <span className="font-semibold">Address:</span> 123 Wellness Street, Green City
          </p>
        </div>
      </section>
    </div>
